(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_713e0294._.js", {
        ...
        "DepartmentsPage.useMemo[filteredAndSortedDepartments]": ()=>{
            ...
            if (searchTerm) {
                processedDepartments = processedDepartments.filter({
                    "DepartmentsPage.useMemo[filteredAndSortedDepartments]": (dept)=>dept.name.toLowerCase().includes(searchTerm.toLowerCase())
                }["DepartmentsPage.useMemo[filteredAndSortedDepartments]"]);
            }
            if (sortConfig.key) {
...
//# sourceMappingURL=_713e0294._.js.map