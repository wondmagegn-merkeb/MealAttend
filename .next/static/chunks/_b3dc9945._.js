(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_b3dc9945._.js", {
...
"[project]/src/components/admin/users/UsersTable.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function UsersTable({ users, onEdit, onDelete, sortConfig, onSort }) {
    ...
    const [userToDelete, setUserToDelete] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useState(null);
...
_s(UsersTable, "IIfltizQdai5oAnjROlaK07GXPg=");
_c = UsersTable;
var _c;
...
function UsersPage() {
        ...
        "UsersPage.useMemo[filteredAndSortedUsers]": ()=>{
            ...
            if (searchTerm) {
                ...
                processedUsers = processedUsers.filter({
                    "UsersPage.useMemo[filteredAndSortedUsers]": (user)=>user.userId.toLowerCase().includes(lowerSearchTerm) || user.fullName.toLowerCase().includes(lowerSearchTerm) || user.department.toLowerCase().includes(lowerSearchTerm) || user.email.toLowerCase().includes(lowerSearchTerm) || user.role.toLowerCase().includes(lowerSearchTerm)
                }["UsersPage.useMemo[filteredAndSortedUsers]"]);
            }
            if (sortConfig.key) {
                processedUsers.sort({
    ...
    const currentTableData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "UsersPage.useMemo[currentTableData]": ()=>{
...
_s(UsersPage, "E2h8D4ZptOBGHj+i0pqSwVpMDoM=", false, function() {
    return [
...
//# sourceMappingURL=_b3dc9945._.js.map