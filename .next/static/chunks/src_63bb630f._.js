...
function NewUserPage() {
    ...
    const mutation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        ...
        onSuccess: {
            "NewUserPage.useMutation[mutation]": (newUser)=>{
        ...
        }["NewUserPage.useMutation[mutation]"],
        onError: {
            "NewUserPage.useMutation[mutation]": (error)=>{
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$activityLogger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logUserActivity"])(actorUserId, "USER_CREATE_FAILURE", `Error: ${error.message}`);
                toast({
...
_s(NewUserPage, "8sLr0GdAuXfEmKOjNI/sJaD2jlE=", false, function() {
    return [
