(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_001f0c2a._.js", {
...
"[project]/src/components/admin/departments/DepartmentsTable.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function DepartmentsTable({ departments, onEdit, onDelete, sortConfig, onSort }) {
    ...
    const [departmentToDelete, setDepartmentToDelete] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useState(null);
...
_s(DepartmentsTable, "Whc8XTwlqj2vM0DMXDL2H9ody9o=");
_c = DepartmentsTable;
var _c;
...
"[project]/src/app/admin/departments/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function DepartmentsPage() {
        ...
        "DepartmentsPage.useEffect": ()=>{
            ...
            try {
                ...
                if (storedDepartmentsRaw) {
                    ...
                    localStorage.setItem(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEPARTMENTS_STORAGE_KEY"], JSON.stringify(initialSeedDepartments));
                }
            } catch (error) {
    ...
    const filteredAndSortedDepartments = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "DepartmentsPage.useMemo[filteredAndSortedDepartments]": ()=>{
            let processedDepartments = [
                ...departments
            ];
            if (searchTerm) {
                const lowerSearchTerm = searchTerm.toLowerCase();
                processedDepartments = processedDepartments.filter({
                    "DepartmentsPage.useMemo[filteredAndSortedDepartments]": (dept)=>dept.name.toLowerCase().includes(lowerSearchTerm) || dept.id.toLowerCase().includes(lowerSearchTerm)
                }["DepartmentsPage.useMemo[filteredAndSortedDepartments]"]);
            }
            if (sortConfig.key) {
                processedDepartments.sort({
                    "DepartmentsPage.useMemo[filteredAndSortedDepartments]": (a, b)=>{
    ...
    const currentTableData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "DepartmentsPage.useMemo[currentTableData]": ()=>{
...
//# sourceMappingURL=_001f0c2a._.js.map