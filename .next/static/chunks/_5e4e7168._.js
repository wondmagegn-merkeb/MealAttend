(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_5e4e7168._.js", {
        ...
        "UsersPage.useMemo[filteredAndSortedUsers]": ()=>{
            ...
            if (searchTerm) {
                processedUsers = processedUsers.filter({
                    "UsersPage.useMemo[filteredAndSortedUsers]": (user)=>user.fullName.toLowerCase().includes(searchTerm.toLowerCase()) || user.department.toLowerCase().includes(searchTerm.toLowerCase()) || user.email.toLowerCase().includes(searchTerm.toLowerCase())
                }["UsersPage.useMemo[filteredAndSortedUsers]"]);
            }
            if (sortConfig.key) {
                processedUsers.sort({
...
//# sourceMappingURL=_5e4e7168._.js.map