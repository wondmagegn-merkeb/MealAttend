...
"[project]/src/components/admin/users/UsersTable.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
;
function UsersTable({ users, onEdit, onDelete, sortConfig, onSort }) {
    ...
    const [userToDelete, setUserToDelete] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].useState(null);
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$admin$2f$users$2f$UsersTable$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/admin/users/UsersTable.tsx [app-ssr] (ecmascript)");
...
function UsersPage() {
    ...
    const { currentUserId: actorUserId } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useAuth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuth"])(); // Renamed to avoid conflict
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        try {
            ...
            if (storedUsersRaw) {
                ...
                localStorage.setItem(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["USERS_STORAGE_KEY"], JSON.stringify(initialSeedUsers));
            }
        } catch (error) {
    ...
    const handleDeleteUser = (internalUserIdToDelete)=>{
        ...
        setTimeout(()=>{
            try {
                ...
                localStorage.setItem(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["USERS_STORAGE_KEY"], JSON.stringify(updatedUsers));
                if (userToDelete) {
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$activityLogger$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["logUserActivity"])(actorUserId, "USER_DELETE_SUCCESS", `Deleted user ID: ${userToDelete.userId}, Name: ${userToDelete.fullName}`);
                } else {
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$activityLogger$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["logUserActivity"])(actorUserId, "USER_DELETE_SUCCESS", `Deleted user with internal ID: ${internalUserIdToDelete}`);
                }
                toast({
                    title: "User Deleted",
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$activityLogger$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["logUserActivity"])(actorUserId, "USER_DELETE_FAILURE", `Attempted to delete user. Error: ${error instanceof Error ? error.message : String(error)}`);
                toast({
                    title: "Error",
    ...
    const filteredAndSortedUsers = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        ...
        if (searchTerm) {
            ...
            processedUsers = processedUsers.filter((user)=>user.userId && user.userId.toLowerCase().includes(lowerSearchTerm) || user.fullName.toLowerCase().includes(lowerSearchTerm) || user.department && user.department.toLowerCase().includes(lowerSearchTerm) || user.email.toLowerCase().includes(lowerSearchTerm) || user.role.toLowerCase().includes(lowerSearchTerm));
        }
        if (sortConfig.key) {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CardContent"], {
                        children: [
                            ...
                            filteredAndSortedUsers.length > ITEMS_PER_PAGE && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            filteredAndSortedUsers.length === 0 && !isLoadingTable && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
...
//# sourceMappingURL=src_9afc9828._.js.map