...
import type { User, PermissionKey } from '@/types/index';
...
export function UserForm({ onSubmit, initialData, isLoading = false, submitButtonText = "Submit", isProfileEditMode = false }: UserFormProps) {
  ...
  const onFormSubmit = async (data: UserFormData) => {
    ...
    if(isProfileEditMode) {
        const { fullName, profileImageURL } = finalData as Partial<UserFormData>;
        finalData = { fullName: fullName!, profileImageURL: profileImageURL };
    }
                    ...
                    <div className="space-y-6">
                        <Card className="shadow-md border-border">
                            <CardHeader>
                                ...
                                <CardDescription>
                                  {isEditingSelf ? "Your permissions are managed by a Super Admin." : "Assign permissions for this user."} 
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
