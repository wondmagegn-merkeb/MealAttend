        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
         <Card>
            ...
            <CardContent className="space-y-6">
                ...
                <FormField control={form.control} name="idPrefix" render={({ field }) => (<FormItem><FormLabel>ID Prefix</FormLabel><FormControl><Input placeholder="e.g., ADERA" {...field} /></FormControl><FormDescription>The prefix used for all auto-generated IDs (e.g., ADERA/STU/...). Use uppercase letters and numbers only.</FormDescription><FormMessage /></FormItem>)} />
            </CardContent>
          </Card>
